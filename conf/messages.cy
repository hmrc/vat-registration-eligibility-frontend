...
businessEntityOther.charitable-incorporated-organisation-2      = Fodd bynnag, bydd CIO sy’n cofrestru gyda’r Comisiwn Elusennau yn cael Rhif Cofrestru’r Cwmni (CRN).
businessEntityOther.charitable-incorporated-organisation-3      = Mae angen CRN er mwyn i CIO gofrestru ar gyfer TAW.
businessEntityOther.charitable-incorporated-organisation-4-start= Gallwch
businessEntityOther.charitable-incorporated-organisation-4-link = bori drwy gofrestr Tŷ’r Cwmnïau
businessEntityOther.charitable-incorporated-organisation-4-end  = ' i ddod o hyd i’ch CRN.'
...
thresholdNextThirtyDays.error.required                  = Dewiswch ‘Iawn’ os oedd y busnes yn disgwyl gwneud mwy nag {0} mewn un mis neu mewn cyfnod o 30 diwrnod
thresholdNextThirtyDays.error.date.required             = Nodwch y dyddiad pan oedd y busnes yn disgwyl gwneud mwy nag {0} mewn un mis neu mewn cyfnod o 30 diwrnod
...
thresholdPreviousThirtyDays.heading.business            = A oedd y busnes yn disgwyl i’w drosiant trethadwy fynd dros {0} mewn unrhyw gyfnod o 30 diwrnod yn y gorffennol?
thresholdPreviousThirtyDays.heading.partnership         = A oedd y bartneriaeth yn disgwyl i’w throsiant trethadwy fynd dros {0} mewn unrhyw gyfnod o 30 diwrnod yn y gorffennol?
...
thresholdPreviousThirtyDays.error.required              = Dewiswch ‘Iawn’ os yw’r busnes yn disgwyl gwneud mwy nag {0} mewn gwerthiannau sy’n agored i TAW yn ystod un cyfnod o 30 diwrnod
...
thresholdInTwelveMonths.p1                                  = Mae’n rhaid i’r busnes fonitro’i drosiant bob mis ac adio’r cyfanswm i gwmpasu’r 12 mis diwethaf. Yr enw ar hyn yw ‘cyfnod treigl o 12 mis’. Os bydd trosiant un mis yn mynd â’r busnes dros {0} yn ystod unrhyw gyfnod treigl o 12 mis, bydd yn rhaid iddo gofrestru ar gyfer TAW.
...
keepOldVrn.bullet1.togc.link                        = ffurflen gais i drosglwyddo rhif cofrestru TAW (yn agor tab newydd)
...
keepOldVrn.bullet1.cole                             = rhaid i’r endid blaenorol lenwi’r
keepOldVrn.bullet1.cole.link                        = ffurflen gais i drosglwyddo rhif cofrestru TAW (yn agor tab newydd)
keepOldVrn.bullet2.cole                             = rhaid i chi wneud cais i gofrestru ar gyfer TAW cyn pen 30 diwrnod ar ôl i’r ffurflen gais i drosglwyddo rhif cofrestru TAW ddod i law CThEF
keepOldVrn.bullet1.tp.togc                          = rhaid i berchennog newydd y busnes, yn ogystal â’r perchennog blaenorol, lenwi’r
keepOldVrn.bullet1.tp.togc.link                     = ffurflen gais i drosglwyddo rhif cofrestru TAW (yn agor tab newydd)
keepOldVrn.bullet2.tp.togc                          = rhaid i chi wneud cais i gofrestru ar gyfer TAW cyn pen 30 diwrnod ar ôl i’r ffurflen gais i drosglwyddo rhif cofrestru TAW ddod i law CThEF
keepOldVrn.bullet1.tp.cole                          = rhaid i’r endid blaenorol lenwi’r
keepOldVrn.bullet1.tp.cole.link                     = ffurflen gais i drosglwyddo rhif cofrestru TAW (yn agor tab newydd)
keepOldVrn.bullet2.tp.cole                          = rhaid i chi wneud cais i gofrestru ar gyfer TAW cyn pen 30 diwrnod ar ôl i’r ffurflen gais i drosglwyddo rhif cofrestru TAW ddod i law CThEF
