...
class FixedEstablishmentViewVarBSpec extends ViewSpecBase {
  ...
  val h1 = "Where does the business have a fixed establishment?"
  val paragraph = "A fixed establishment exists if either the:"
  val bullet1 = "place where essential management decisions are made and the business’s central administration is carried out"
