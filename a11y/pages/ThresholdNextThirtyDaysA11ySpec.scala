...
class ThresholdNextThirtyDaysA11ySpec extends A11ySpec with ThresholdService {
  ...
  val view: ThresholdNextThirtyDays = app.injector.instanceOf[ThresholdNextThirtyDays]
  val form: ThresholdNextThirtyDaysFormProvider = app.injector.instanceOf[ThresholdNextThirtyDaysFormProvider]
